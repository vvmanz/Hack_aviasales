...
Запустите файл main.py. Откроется сервер Flask.
Затем в терминале введите "streamlit run streamlit_front.py". Откроется само приложение в браузере.
...
>>>>>>> 8b77115f08340f62ed3bd4ec76139c58fcac488c
